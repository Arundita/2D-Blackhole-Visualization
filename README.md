...
4. The angle of rotation is incremented by the speed of the object. At every frame, the x and y coordinates are calculated as sine and cosine of the angle of rotation.<br>
